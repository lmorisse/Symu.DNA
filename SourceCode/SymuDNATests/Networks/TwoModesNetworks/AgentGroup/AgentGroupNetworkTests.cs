...
namespace SymuDNATests.Networks.TwoModesNetworks.AgentGroup
{
    [TestClass]
    public class AgentGroupNetworkTests
    {
        ...
        private TestAgentGroup _agentGroup;
        private TestAgentGroup _agentGroup2;
        private TestAgentGroup _agentGroup3;

        [TestInitialize]
        public void Initialize()
        {
            _agentGroup = new TestAgentGroup(_teammateId, 100);
            _agentGroup2 = new TestAgentGroup(_teammateId2, 100);
            _agentGroup3 = new TestAgentGroup(_teammateId3, 100);
        }
        ...
        {
            _group.AddAgent(_agentGroup, _teamId);
            _group.AddAgent(_agentGroup, _teamId2);
            _group.RemoveAgent(_teammateId);
            Assert.IsFalse(_group.IsMemberOfGroup(_teammateId, _teamId));
        ...
        public void GetTeammatesCountTest()
        {
            ...
            _group.AddAgent(_agentGroup, _teamId); //Check Duplication 
            Assert.AreEqual(1, _group.GetAgentsCount(_teamId));
        }
        ...
        public void GetCoMemberIds()
        {
            ...
            _group.AddAgent(_agentGroup, _teamId);
            Assert.AreEqual(0, _group.GetCoMemberIds(_teammateId, _teamId.ClassId).Count());
            _group.AddAgent(_agentGroup2, _teamId);
            Assert.AreEqual(1, _group.GetCoMemberIds(_teammateId, _teamId.ClassId).Count());
            _group.AddAgent(_agentGroup3, _teamId2);
            Assert.AreEqual(1, _group.GetCoMemberIds(_teammateId, _teamId.ClassId).Count());
            _group.AddAgent(_agentGroup, _teamId2);
        ...
        {
            // Test increment
            _agentGroup = new TestAgentGroup(_teammateId, 50);
            _group.AddAgent(_agentGroup, _teamId);
        ...
        public void GetMemberAllocationsTest()
        {
            ...
            _agentGroup2 = new TestAgentGroup(_teammateId2, 50);
            _group.AddAgent(_agentGroup2, _teamId);
