...
namespace SymuDNATests.Networks.TwoModesNetworks.Interaction
{
    [TestClass]
    public class InteractionNetworkTests
    {
        ...
        private TestInteraction _interaction12;
        private TestInteraction _interaction21;
        private TestInteraction _interaction31;

        [TestInitialize]
        public void Initialize()
        {
            _interaction12 = new TestInteraction(_agentId1, _agentId2);
            _interaction21 = new TestInteraction(_agentId2, _agentId1);
            _interaction31 = new TestInteraction(_agentId3, _agentId1);
        }
        ...
        public void GetActiveLinksTest()
        {
            ...
            var interaction = new TestInteraction(_agentId1, teammateId4);
        ...
        {
            var link = new TestInteraction(_agentId1, _agentId2);
