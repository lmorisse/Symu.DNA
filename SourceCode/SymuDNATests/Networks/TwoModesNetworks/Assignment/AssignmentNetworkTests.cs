...
namespace SymuDNATests.Networks.TwoModesNetworks.Assignment
{
    [TestClass]
    public class AssignmentNetworkTests
    {
        private List<TestAgentActivity> _activities ;
        private readonly TestActivity _activity1 = new TestActivity(1);
        private readonly TestActivity _activity2 = new TestActivity(2);
