...
namespace SymuDNATests.Classes
{
    ...
    /// </summary>
    public class TestAgentAgent : IAgentAgent
    {
        /// <summary>
        ///     Constructor
        /// </summary>
        ...
        public TestAgentAgent(IAgentId agentId1, IAgentId agentId2)
        {
            if (agentId1 == null)
            {
        ...
        public TestAgentAgent(IAgentId agentId1, IAgentId agentId2, float weight) : this(agentId1, agentId2)
        {
            Weight = weight;
        }
        ...
        {
            return obj is TestAgentAgent link &&
