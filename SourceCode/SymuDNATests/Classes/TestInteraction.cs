...
namespace SymuDNATests.Classes
{
    ...
    /// </summary>
    public class TestInteraction : IInteraction
    {
        /// <summary>
        ///     Constructor
        /// </summary>
        ...
        public TestInteraction(IAgentId agentId1, IAgentId agentId2)
        {
            if (agentId1 == null)
            {
        ...
        public TestInteraction(IAgentId agentId1, IAgentId agentId2, float weight) : this(agentId1, agentId2)
        {
            Weight = weight;
        }
        ...
        {
            return obj is TestInteraction link &&
