...
namespace Symu.DNA.Metrics.TwoModes
{
    ...
    public static class VarianceMetrics
    {
        ...
        /// Highly centralized networks are often not very robust since single nodes have very much power, influence, or control over the network and removing these nodes can endanger the whole network
        /// </summary>
        ...
        public static float DegreeCentralization(Matrix<float> matrix)
        {
            ...
            var tempMatrix = Matrix<float>.Build.Dense(matrix.RowCount, matrix.ColumnCount, maxDegree) - degreeCentrality;
