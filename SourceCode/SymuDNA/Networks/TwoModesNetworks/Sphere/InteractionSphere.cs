...
namespace Symu.DNA.Networks.TwoModesNetworks.Sphere
{
    /// <summary>
    ...
    public class InteractionSphere
    {
            ...
            AgentKnowledgeNetwork knowledgeNetwork)
        {
            ...
            foreach (var knowledgeId in knowledgeIds)
            {
                ...
                var agentKnowledge1 = knowledgeNetwork.GetAgentKnowledge(agentId1, knowledgeId);
                var agentKnowledge2 = knowledgeNetwork.GetAgentKnowledge(agentId2, knowledgeId);
